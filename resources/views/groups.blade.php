                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">PICK A COMPETITION TO FORM A GROUP FROM</h1>
                            <p class="animate__animated animate__backInLeft">
                                only members who are in the the competition selected can join the group you create
                            </p>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <select class="w-full border bg-white rounded px-3 py-2 outline-none" name="id">
                                            @foreach ($competitions as $competition)
                                            <option value="{{$competition->id}}" class="py-1">{{$competition->name}}</option>
                                            @endforeach
