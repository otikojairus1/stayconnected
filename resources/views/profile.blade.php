            ...
            <div class="md:flex no-wrap md:-mx-2 ">
                ...
                <div class="w-full md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white p-3 border-t-4 border-green-400 animate__animated animate__backInDown">
                        ...
                        <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{$data->lastname}}</h1>
                        <h3 class="text-gray-600 font-lg text-semibold leading-6">{{$data->firstname}} <span class="ml-2"></span>{{Auth::user()->lastname}}</h3>
                        <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">{{$data->bio}}
                            </p>
                        <ul
                            ...
                            <li class="flex items-center py-3">
                                ...
                                <span class="ml-auto"><span
                                        ...
                                        <a href="/dm/{{$data->email}}"> <span
                                        class="bg-yellow-500 py-1 px-2 rounded text-white text-sm">Direct Message</span></a></span>
                            </li>
                            <li class="flex items-center py-3">
