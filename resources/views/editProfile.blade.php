<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            UPDATE YOUR DETAILS |  CHANGE YOUR PROFILE DETAILS IN ONE PLACE
        </h2>
    </x-slot>
        ...
        <div class="min-w-screen min-h-screen bg-white flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                <div class="md:flex w-full">
                    <div class="animate__animated animate__backInRight hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">UPDATE YOUR PERSONAL DETAILS</h1>
                            <p class="animate__animated animate__backInLeft">
                                These details will be seen in your profile when some one searches you. 
                                Technically, its seen with every one who looks for you.
                            </p>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      @endif
                        ...
                        <div>
                            ...
                            <div class="py-3 animate__animated animate__backInRight px-5 mb-4 bg-red-100 text-red-900 text-sm rounded-md border border-red-200" role="alert">
                                {{ $error }}
                            </div>
                            @endforeach
                                ...
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <select class="w-full border bg-white rounded px-3 py-2 outline-none" name="gender">
                                            ...
                                            <option class="py-1">OTHER</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">CONTACT NO</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input  value="{{$userDetails->contactNo}}"type="text" name="contact"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="update your contact no...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">CURRENT ADDRESS</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input  value="{{$userDetails->currentAddress}}"type="text" name="cadress"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="update your current address...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">PERMANENT ADDRESS</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input  value="{{$userDetails->permanentAddress}}"type="text" name="paddress"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="update your permanent address...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input  value="{{$userDetails->birthday}}"type="text" name="birthday"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="update yout birthday here...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">WORK EXPERIENCE</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input  value="{{$userDetails->experience}}"type="text" name="work"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="update your work experience">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">EDUCATION</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input  value="{{$userDetails->education}}"type="text" name="education"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="update your education details here...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5 animate__animated animate__backInLeft">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">SAVE DETAILS</button>
                                </div>
                            </div>
                        </div>
                    </div>
