        ...
        <div class="container mx-auto my-5 p-5">
                ...
                <div class="w-full md:w-9/12 mx-2 h-64 animate__animated animate__backInRight">
                    ...
                    <div class="bg-green-lightest my-2 border-l-4 border-green text-green-dark p-4" role="alert">
                        <div class="flex">
                            <p class="font-bold mr-3">{{$post->title}} </p>
                            posted by <p class="ml-3">{{\App\Models\User::find($post->user_id)->lastname}}<p class="ml-2">{{\App\Models\User::find($post->user_id)->firstname}}</p>
                        </div>
