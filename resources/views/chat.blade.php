                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">CONTACT CUSTOMER SERVICE</h1>
                            <p class="animate__animated animate__backInLeft">Enter your information and what you have to say. Our representatives will get back 
                                to you very soon
                            </p>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      @endif
                        ...
                        <div>
                            ...
                            @endforeach
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5 animate__animated animate__backInLeft">
                                    <label for="" class="text-xs font-semibold px-1">First name</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" name="firstname" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5 animate__animated animate__backInRight">
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInUp">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <textarea  name="message"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="your message for us here..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5 animate__animated animate__backInLeft">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">SEND</button>
                                </div>
                            </div>
                        </div>
                    </div>
