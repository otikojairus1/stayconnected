<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            COMPOSE MESSAGE | INVITE MEETING
        </h2>
    </x-slot>
                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">INVITE MEETING</h1>
                            <p class="animate__animated animate__backInLeft">
                                This is a private message and therefore visible in the users inbox!
                            </p>
                        ...
                        <div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">REFERENCE</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input required type="text" name="reference"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Meeting reference here...">
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3 animate__animated animate__backInUp">
                                <div class="w-full px-3 mb-12">
                                    <label for="" class="text-xs font-semibold px-1">RECIPIENT EMAIL</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <input  required name="email"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="please input a VALID recipient email for delivery..."/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInUp">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <textarea  required name="description"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="your meeting description here..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5 animate__animated animate__backInLeft">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">INVITE</button>
                                </div>
                            </div>
                        </div>
                    </div>
