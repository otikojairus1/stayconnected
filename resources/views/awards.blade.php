<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
           MANAGE AWARDS   <a href="/winners">  <div class="mt-5 ml-4 py-3 px-5 mb-4 bg-green-100 text-green-900 text-sm rounded-md border border-green-200" role="alert">
                ALL WINNERS
             </div></a>
        </h2>
    </x-slot>
    ...
    <div class="bg-gray-100">
        <form action="/award/competitors" method="POST">
            @csrf
                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">PICK A COMPETITION TO AWARD WINNERS FROM</h1>
                            <p class="animate__animated animate__backInLeft">
                                The system can only award users competing in the specifies competition
                            </p>
                        ...
                        <div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">COMPETITION NAME</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <select class="w-full border bg-white rounded px-3 py-2 outline-none" name="name">
                                            @foreach ($competitions as $competition)
                                            <option class="py-1">{{$competition->name}}</option>
                                            @endforeach
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5 animate__animated animate__backInLeft">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">PROCEED</button>
                                </div>
                            </div>
                        </div>
                    </div>
