...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ALL WINNERS | a list of all winners in the competition
        </h2>
    </x-slot>
        ...
        <div class="container mx-auto my-5 p-5">
                ...
                <div class="w-full md:w-9/12 mx-2 h-64 animate__animated animate__backInRight">
                    ...
                    <div class="bg-green-lightest my-2 border-l-4 border-green text-green-dark p-4" role="alert">
                        <div class="flex">
                            <p class="font-bold mr-3">{{App\Models\Competition::find($detail->CompetitionId)->name}} </p>
                            WON BY <p class="ml-3">{{\App\Models\User::find($detail->userId)->lastname}}<p class="ml-2">{{\App\Models\User::find($detail->userId)->firstname}}</p>
                        </div>
                        <p></p>
                        <p class="font-bold">won at {{$detail->created_at}}</p>
