    ...
    <div class="bg-gray-100">
        ...
        <div class="container mx-auto my-5 p-5">
                ...
                <div class="w-full md:w-9/12 mx-2 h-64 animate__animated animate__backInRight">
                    ...
                    <div class="flex ">
                       NAME: <p class="mr-3 font-bold">{{App\Models\User::find($groupmember->userid)->firstname}}</p>
                        <p class="font-bold">{{App\Models\User::find($groupmember->userid)->lastname}}</p>
                        {{-- <p class="font-bold">posted at {{$post->created_at}}</p> --}}
                    </div> 
                    EMAIL: <p class="font-bold">{{App\Models\User::find($groupmember->userid)->email}}</p> 
                   GROUP MEMBER ID: <p class="font-bold">{{App\Models\User::find($groupmember->userid)->id}}</p> 
