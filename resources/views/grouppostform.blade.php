<x-app-layout>
    ...
    <div class="bg-gray-100">
        <form action="/send/group/post" method="POST">
            @csrf
                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">SEND A GROUP POST</h1>
                            <p class="animate__animated animate__backInLeft">
                                Your post is visible to all group members!
                            </p>
                        ...
                        <div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInUp">
                                <div class="w-full px-3 mb-12">
                                    <label for="" class="text-xs font-semibold px-1">POST</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <textarea  required name="content"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="your group post here..."></textarea>
                                    </div>
                                </div>
                            </div>
