<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            SEND DIRECT MESSAGE   <a href="#">  <div class="mt-5 ml-4 py-3 px-5 mb-4 bg-grey-100 text-grey-900 text-sm rounded-md border border-green-200" role="alert">
                SAY HI TO A FRIEND
             </div></a>
        </h2>
    </x-slot>
                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="animate__animated animate__backInUp font-bold text-3xl text-gray-900">SEND A DIRECT MESSAGE</h1>
                            <p class="animate__animated animate__backInLeft">
                                This message  can only be seen by the user you are sending a DM to!
                            </p>
                        ...
                        <div>
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInLeft">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">SEND A DIRECT MESSAGE TO:</label>
                                    <div class="flex">
                            ...
                            <div class="flex -mx-3 animate__animated animate__backInUp">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <textarea  name="content"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="My messae here..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5 animate__animated animate__backInLeft">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">SEND DIRECT MESSAGE</button>
                                </div>
                            </div>
                        </div>
                    </div>
